package com.snowaze.app.common.utils.pager
    ...
    Layout(
        ...
        modifier = modifier.draggable(
            ...
            state = rememberDraggableState { deltaInPx ->
                coroutineScope.calculateNewPosition(deltaInPx, state, pageSize, offscreenLimit, canProceed)
            },
        )
...
private fun CoroutineScope.calculateNewPosition(
    ...
    launch {
        with(state) {
            ...
            if (canProceed(currentPage)) { // Add this line
